...
# Configuration
# ---------------------------------------------------------------------------
readonly NAMESPACE="google-adk-demo"
readonly CHART_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/charts/google-adk-demo" && pwd)"
...
echo "╠══════════════════════════════════════════════════════════╣"
printf "║  %-56s ║\n" "Namespace : $NAMESPACE"
printf "║  %-56s ║\n" "Agent     : google-adk-demo-svc.${NAMESPACE}.svc.cluster.local:80"
echo "╚══════════════════════════════════════════════════════════╝"
