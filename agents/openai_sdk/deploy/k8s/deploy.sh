...
# Configuration
# ---------------------------------------------------------------------------
readonly NAMESPACE="openai-sdk-demo"
readonly CHART_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/charts/openai-sdk-demo" && pwd)"
...
helm upgrade openai-sdk-demo "$CHART_DIR" \
  --install \
  --namespace "$NAMESPACE" \
...
echo "║  Agent     : openai-sdk-demo-svc.${NAMESPACE}.svc.cluster.local:80"
echo "╚══════════════════════════════════════════════════════════════════════════════════════════╝"
