...
NAMESPACE="o-sdk-demo"
CHART_DIR="$(cd "$(dirname "$0")/charts/o-sdk-demo" && pwd)"
...
echo "Installing o-sdk-demo..."
helm upgrade o-sdk-demo "$CHART_DIR" \
  --install \
  --namespace "$NAMESPACE" \
...
echo ""
echo "o-sdk-demo deployed successfully."
echo "  Agent: o-sdk-demo-svc.${NAMESPACE}.svc.cluster.local:80"
