...
ARCH_SVG = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 760 390"
     style="width:100%;max-height:390px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif">
  <defs>
  ...
  <!-- User → Agent -->
  <path d="M 380 62 L 380 94"
        fill="none" stroke="#94a3b8" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ── LANGGRAPH AGENT box (includes OpenRouter) ── -->
  <rect x="175" y="94" width="410" height="80" rx="12"
        fill="#dcfce7" stroke="#16a34a" stroke-width="2" filter="url(#sh)"/>
  <text x="380" y="120" text-anchor="middle" font-size="13" font-weight="700" fill="#15803d">LangGraph Agent</text>
  <text x="380" y="139" text-anchor="middle" font-size="10.5" fill="#166534">LLM decides which tool to call</text>
  <!-- OpenRouter badge -->
  <rect x="325" y="149" width="110" height="20" rx="10"
        fill="#fff" stroke="#16a34a" stroke-width="1" opacity="0.8"/>
  <text x="380" y="163" text-anchor="middle" font-size="9.5" font-weight="600" fill="#15803d">via OpenRouter</text>

  <!-- Agent → Proxy (tool calls) -->
  <path d="M 380 174 L 380 222"
        fill="none" stroke="#94a3b8" stroke-width="1.5" marker-end="url(#arr)"/>
  <text x="414" y="200" font-size="9.5" fill="#64748b" font-style="italic">tool 1, tool 2 &#8230;</text>

  <!-- ── ACUVITY PROXY circle (IBAC model inside) ── -->
  <circle cx="380" cy="284" r="62"
          fill="#fef9c3" stroke="#f59e0b" stroke-width="3.5" filter="url(#sh)"/>
  <text x="380" y="274" text-anchor="middle" font-size="12" font-weight="700" fill="#92400e">Acuvity Proxy</text>
  <!-- IBAC model label inside circle -->
  <rect x="338" y="281" width="84" height="18" rx="9"
        fill="#f59e0b" opacity="0.25"/>
  <text x="380" y="294" text-anchor="middle" font-size="9.5" font-weight="600" fill="#78350f">IBAC model</text>

  <!-- Proxy → BLOCKED (left) -->
  <path d="M 318 284 L 228 284"
        fill="none" stroke="#dc2626" stroke-width="1.5" marker-end="url(#arr-red)"/>
  <text x="272" y="275" text-anchor="middle" font-size="9" fill="#dc2626" font-style="italic">misaligned</text>

  <!-- ── BLOCKED box (left) ── -->
  <rect x="48" y="258" width="180" height="54" rx="10"
        fill="#fef2f2" stroke="#fca5a5" stroke-width="1.5" filter="url(#sh)"/>
  <text x="138" y="280" text-anchor="middle" font-size="12" font-weight="700" fill="#dc2626">BLOCKED</text>
  <text x="138" y="298" text-anchor="middle" font-size="10"                   fill="#ef4444">+ Alert raised</text>

  <!-- Proxy → Tool executes (right) -->
  <path d="M 442 284 L 532 284"
        fill="none" stroke="#16a34a" stroke-width="1.5" marker-end="url(#arr-grn)"/>
  <text x="487" y="275" text-anchor="middle" font-size="9" fill="#16a34a" font-style="italic">aligned</text>

  <!-- ── TOOL EXECUTES box (right) ── -->
  <rect x="532" y="258" width="180" height="54" rx="10"
        fill="#f0fdf4" stroke="#16a34a" stroke-width="2" filter="url(#sh)"/>
  <text x="622" y="280" text-anchor="middle" font-size="12" font-weight="700" fill="#15803d">Tool executes</text>
  <text x="622" y="298" text-anchor="middle" font-size="10"                   fill="#166534">CRM · email · files</text>

  <!-- Tool executes → loop back to Agent (right side curve) -->
  <path d="M 712 270 C 740 270, 740 134, 585 134"
        fill="none" stroke="#16a34a" stroke-width="1.5" stroke-dasharray="5,3"
        marker-end="url(#arr-grn)"/>
  <text x="748" y="210" text-anchor="middle" font-size="9" fill="#16a34a" font-style="italic"
        transform="rotate(90,748,210)">result (loop)</text>

  <!-- Agent → User (answer, left side) -->
  <path d="M 175 126 C 110 126, 100 58, 308 44"
        fill="none" stroke="#94a3b8" stroke-width="1" stroke-dasharray="5,3"
        marker-end="url(#arr)"/>
  <text x="116" y="88" font-size="9" fill="#94a3b8" font-style="italic">answer</text>
</svg>"""
