...
def setup_otel(cfg: dict):
    ...
    for instrumentor in cfg["otel"]["instrumentors"]:
        ...
        if name == "HTTPXClientInstrumentor":
            HTTPXClientInstrumentor().instrument()
        elif name == "AioHttpClientInstrumentor":
            AioHttpClientInstrumentor().instrument()
        elif name == "ThreadingInstrumentor":
            ThreadingInstrumentor().instrument()
        elif name == "MCPInstrumentor":
            MCPInstrumentor().instrument()
        elif name == "GoogleADKInstrumentor":
            GoogleADKInstrumentor().instrument()
        elif name == "LiteLLMInstrumentor":
